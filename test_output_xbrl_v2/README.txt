...
★★★ CON DATOS FINANCIEROS PRE-LLENADOS ★★★
================================================================================

Empresa: Empresa de Prueba XBRL
ID RUPS: 99999
NIT: 900123456
Taxonomía: Resolución 414 - Sector Público
Fecha de Reporte: 2023-12-31
Generado: 30/11/2025, 9:21:49 p. m.
Cuentas procesadas: 3734
Servicios activos: acueducto, alcantarillado, aseo

================================================================================
CONTENIDO DEL PAQUETE
================================================================================

1. R414_Individual_ID99999_2023-12-31.xbrlt
   → Plantilla de mapeo XBRL (para XBRL Express)

2. R414_Individual_ID99999_2023-12-31.xml
   → Configuración de mapeo Excel → XBRL

3. R414_Individual_ID99999_2023-12-31.xlsx
   → Plantilla Excel oficial (PRE-LLENADA con datos)

4. R414_Individual_ID99999_2023-12-31.xbrl
...
PASO 2: Revisar y complementar el Excel
   1. Abra el archivo .xlsx con Microsoft Excel
   2. Revise que los datos automáticos sean correctos
   3. Complete las hojas de notas y revelaciones
...
- Los archivos de este paquete fueron generados usando las plantillas
  OFICIALES de la SSPD para la taxonomía Resolución 414 - Sector Público.
