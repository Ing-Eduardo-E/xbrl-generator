...
export default function ThemeToggle() {
  ...
  const label = displayTheme === 'system' ? 'Sistema' : displayTheme === 'dark' ? 'Oscuro' : 'Claro'
    ...
    >
      <span className="relative w-4 h-4">
        ...
        <Monitor className={cn(
          "absolute inset-0 w-4 h-4 transition-all duration-300",
          displayTheme === 'system' ? "opacity-100 rotate-0 scale-100" : "opacity-0 rotate-90 scale-0"
        )} />
      </span>
