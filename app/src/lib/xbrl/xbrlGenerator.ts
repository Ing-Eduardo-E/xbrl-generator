...
<!-- XBRL Report (Instance) generated using XBRL Generator Web App -->
<!-- https://github.com/xbrl-generator -->
<!-- Generado para: ${options.companyName} -->
...
<xbrli:xbrl 
  ...
  <!-- Referencia al esquema de la taxonomía -->
  <link:schemaRef xlink:type="simple" xlink:href="${config.entryPoint}"/>
  
  <!-- 
    NOTA: Este archivo contiene la estructura básica de la instancia XBRL.
    Los hechos (facts) deben ser completados usando XBRL Express después de 
    cargar la plantilla Excel generada.
  -->
